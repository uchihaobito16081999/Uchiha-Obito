...
//		setContentPane(contentPane);
	...
	private void initialize() throws IOException {
		...
		frameMain.setBounds(100,100,900,560);
...
//		});
		...
		JLabel lblUserName = new JLabel("Group Name :");
		lblUserName.setBounds(192, 6, 91, 16);
		lblUserName.setForeground(new Color(0, 191, 255));
		frameMain.getContentPane().add(lblUserName);
		
		textField_1 = new JTextField();
		textField_1.setBounds(295, 1, 156, 26);
...
//		frameMain.getContentPane().add(textArea);
		...
		scroll_bar.setBounds(192,121,490,303);
...
//		
		...
		sendPictureButton.setBounds(621, 49, 60, 60);
		...
		sendFilebutton.setBounds(195, 49, 60, 60);
		frameMain.getContentPane().add(sendFilebutton);
		
		JList list = new JList();
		list.setBounds(712, 30, 164, 502);
		
		JScrollPane sp4GroupMember = new JScrollPane(list);
		sp4GroupMember.setBounds(712,30,164,502);
		...
		lblNewLabel.setBounds(712, 6, 164, 16);
